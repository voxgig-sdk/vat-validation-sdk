// Command VatValidation-mcp is an MCP server exposing the VatValidation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	VatValidation_list  — list records of an entity
//	VatValidation_load  — load a single record of an entity
//
