...
AQL-driven CLI and REPL for the VatValidation SDK. Positional arguments are
...
./vat-validation-cli load 1 country
./vat-validation-cli load '{id:1}' country
