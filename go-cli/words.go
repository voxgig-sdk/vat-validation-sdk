...
func registerSDKWords(r *eng.Registry, client *sdk.VatValidationSDK) {
...
func runOp(client *sdk.VatValidationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
