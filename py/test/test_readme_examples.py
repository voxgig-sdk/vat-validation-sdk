# VatValidation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions VatValidationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both VatValidationSDK(...) and VatValidationSDK.test(...) become
#      VatValidationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "vatvalidation_sdk"
_SDK_CLASS = "VatValidationSDK"
...
_ENTITIES = {
    ...
    "Geolocate": "geolocate",
    "Rate": "rate",
    "ValidateIbanResponseSchema": "validate_iban_response_schema",
    "ValidateVatResponseSchema": "validate_vat_response_schema",
    "VatcomplyApiRoot": "vatcomply_api_root",
}
