...
class VatValidationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = VatValidationTestRunner.getenv("VATVALIDATION_TEST_LIVE")
        override = VatValidationTestRunner.getenv("VATVALIDATION_TEST_OVERRIDE")
        ...
        explain = VatValidationTestRunner.getenv("VATVALIDATION_TEST_EXPLAIN")
