...
class VatcomplyApiRootEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return VatcomplyApiRootEntity(self._client, opts)
    ...
    def data_get(self) -> VatcomplyApiRoot:
    ...
    def match_get(self) -> VatcomplyApiRoot:
    ...
    def load(self, reqmatch=None, ctrl=None) -> VatcomplyApiRoot:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.VatcomplyApiRoot().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
