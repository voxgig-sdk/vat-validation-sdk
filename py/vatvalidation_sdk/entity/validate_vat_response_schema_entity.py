...
from vatvalidation_sdk.vatvalidation_types import (
...
class ValidateVatResponseSchemaEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ValidateVatResponseSchemaEntity(self._client, opts)
    ...
    def data_get(self) -> ValidateVatResponseSchema:
    ...
    def match_get(self) -> ValidateVatResponseSchema:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ValidateVatResponseSchema:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ValidateVatResponseSchema().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
