...
class ValidateIbanResponseSchemaEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ValidateIbanResponseSchemaEntity(self._client, opts)
    ...
    def data_get(self) -> ValidateIbanResponseSchema:
    ...
    def match_get(self) -> ValidateIbanResponseSchema:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ValidateIbanResponseSchema:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ValidateIbanResponseSchema().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
