...
from vatvalidation_sdk.core.control import VatValidationControl
...
from vatvalidation_sdk.core.helpers import get_ctx_prop, to_map
...
class VatValidationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = VatValidationControl()
        ...
        if isinstance(sp, VatValidationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, VatValidationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, VatValidationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return VatValidationError(code, msg, self)
