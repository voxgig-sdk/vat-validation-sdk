...
class CurrencyEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set VATVALIDATION_TEST_CURRENCY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function currency_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("VATVALIDATION_TEST_CURRENCY_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["VATVALIDATION_TEST_CURRENCY_ENTID"]);
