...
// VatValidation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (VatValidationSDK::test)
...
{
    private const SDK_CLASS = 'VatValidationSDK';
    ...
    private const SDK_BASE = 'vatvalidation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../vatvalidation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
