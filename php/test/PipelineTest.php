...
// VatValidation SDK pipeline test
//
...
{
    private static function utility(): VatValidationUtility
    {
        return new VatValidationUtility();
    }
    ...
    private static function ctx(array $over = []): VatValidationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new VatValidationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new VatValidationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof VatValidationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new VatValidationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = VatValidationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new VatValidationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = VatValidationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new VatValidationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = VatValidationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new VatValidationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = VatValidationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new VatValidationResponse([]),
            'result' => new VatValidationResult([]),
        ]);
        [, $err] = VatValidationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new VatValidationSpec([]),
            'response' => null,
            'result' => new VatValidationResult([]),
        ]);
        [, $err] = VatValidationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new VatValidationSpec(['step' => 's']),
            'response' => new VatValidationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new VatValidationResult([]),
        ]);
        [, $err] = VatValidationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new VatValidationSpec(['step' => 's']),
            'response' => new VatValidationResponse(self::resp(200, ['v' => 1])),
            'result' => new VatValidationResult([]),
        ]);
        [, $err] = VatValidationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new VatValidationSpec(['step' => 's']),
            'response' => new VatValidationResponse(self::resp(200, ['v' => 2])),
            'result' => new VatValidationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        VatValidationMakeResponse::call($ctx);
    ...
    {
        $preset = new VatValidationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new VatValidationSpec([]),
            'response' => new VatValidationResponse([]),
            'result' => new VatValidationResult([]),
        ...
        [$got, $err] = VatValidationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new VatValidationResult([])]);
        [, $err] = VatValidationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new VatValidationSpec([]), 'result' => null]);
        [, $err] = VatValidationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new VatValidationSpec(['step' => 's']),
            'result' => new VatValidationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new VatValidationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = VatValidationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new VatValidationSpec(['step' => 's']),
            'result' => new VatValidationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new VatValidationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = VatValidationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new VatValidationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new VatValidationSpec([]),
            'result' => new VatValidationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = VatValidationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = VatValidationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new VatValidationError('boom', 'boom');
        $utility->fetcher = function (VatValidationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new VatValidationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = VatValidationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (VatValidationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        VatValidationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (VatValidationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new VatValidationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = VatValidationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new VatValidationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new VatValidationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = VatValidationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = VatValidationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = VatValidationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new VatValidationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, VatValidationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new VatValidationResult(['ok' => false])]);
        $this->expectException(VatValidationError::class);
        VatValidationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new VatValidationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', VatValidationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        VatValidationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new VatValidationBaseFeature();
        $b = new VatValidationBaseFeature();
        VatValidationFeatureAdd::call($ctx, $a);
        VatValidationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): VatValidationBaseFeature
    {
        $f = new VatValidationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        VatValidationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): VatValidationContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new VatValidationSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = VatValidationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        VatValidationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new VatValidationResponse(['headers' => null]),
            'result' => new VatValidationResult([]),
        ]);
        VatValidationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        VatValidationResultBody::call($ctx);
