...
// VatValidation SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = VatValidationOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(VatValidationOmni::structfix($now, Struct::undef()))
                        !== json_encode(VatValidationOmni::structfix($val, Struct::undef()))) {
