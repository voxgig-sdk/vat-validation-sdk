...
// VatValidation SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class VatValidationTransformResponse
{
    public static function call(VatValidationContext $ctx): mixed
    {
        ...
        $transform = VatValidationHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
