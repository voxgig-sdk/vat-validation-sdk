...
// VatValidation SDK utility: fetcher

class VatValidationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; VatValidationSDK/1.0)';
    ...
    public static function call(VatValidationContext $ctx, string $fullurl, array $fetchdef): array
    {
