...
// VatValidation SDK Geolocate entity
...
class GeolocateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GeolocateEntity($this->_client, $opts);
    }

    /**
     * @param Geolocate|array $args Geolocate data (assoc-array) to store.
     */
    ...
    /**
     * @return Geolocate|array The current Geolocate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Geolocate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Geolocate fields).
     */
     ...
     *
     * @param GeolocateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GeolocateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Geolocate|array The loaded Geolocate as an assoc-array at the
