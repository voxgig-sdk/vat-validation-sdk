...
// VatValidation SDK VatcomplyApiRoot entity
...
class VatcomplyApiRootEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new VatcomplyApiRootEntity($this->_client, $opts);
    }

    /**
     * @param VatcomplyApiRoot|array $args VatcomplyApiRoot data (assoc-array) to store.
     */
    ...
    /**
     * @return VatcomplyApiRoot|array The current VatcomplyApiRoot data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of VatcomplyApiRoot fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of VatcomplyApiRoot fields).
     */
    ...
    /**
     * Load a single VatcomplyApiRoot.
     *
     * @param VatcomplyApiRootLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed VatcomplyApiRootLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return VatcomplyApiRoot|array The loaded VatcomplyApiRoot as an assoc-array at the
