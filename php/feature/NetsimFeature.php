...
// VatValidation SDK netsim feature
...
class VatValidationNetsimFeature extends VatValidationBaseFeature
{
    ...
    private function _simulate(VatValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(VatValidationContext $ctx, array $applied): void
    {
        $client = $this->client;
