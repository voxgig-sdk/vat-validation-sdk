...
// VatValidation SDK proxy feature
...
class VatValidationProxyFeature extends VatValidationBaseFeature
{
    ...
    public function init(VatValidationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (VatValidationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
