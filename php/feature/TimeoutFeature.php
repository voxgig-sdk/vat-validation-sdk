...
// VatValidation SDK timeout feature
...
class VatValidationTimeoutFeature extends VatValidationBaseFeature
{
    ...
    private function _with_timeout(VatValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(VatValidationContext $_ctx, float $ms): void
    {
        $client = $this->client;
