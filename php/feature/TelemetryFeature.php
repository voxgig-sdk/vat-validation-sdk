...
// VatValidation SDK telemetry feature
...
class VatValidationTelemetryFeature extends VatValidationBaseFeature
{
    ...
    private function _close(VatValidationContext $ctx, bool $ok): void
    {
