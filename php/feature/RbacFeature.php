...
// VatValidation SDK rbac feature
...
class VatValidationRbacFeature extends VatValidationBaseFeature
{
    ...
    private function _required(VatValidationContext $ctx): ?string
    {
    ...
    private function _reject(VatValidationContext $ctx, string $required): void
    {
    ...
    private function _track(VatValidationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
