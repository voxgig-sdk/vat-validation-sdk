...
class CountryEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set VATVALIDATION_TEST_COUNTRY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def country_basic_setup(extra)
  ...
  entid_env_raw = ENV["VATVALIDATION_TEST_COUNTRY_ENTID"]
