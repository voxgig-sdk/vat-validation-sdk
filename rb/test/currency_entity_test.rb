...
class CurrencyEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set VAT_VALIDATION_TEST_CURRENCY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def currency_basic_setup(extra)
  ...
  entid_env_raw = ENV["VAT_VALIDATION_TEST_CURRENCY_ENTID"]
