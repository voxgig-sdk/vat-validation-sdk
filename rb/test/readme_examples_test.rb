...
#      offline in seeded test mode (VatValidationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "VatValidation_sdk.rb")
  SDK_CLASS = "VatValidationSDK"
