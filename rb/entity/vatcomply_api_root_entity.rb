...
class VatcomplyApiRootEntity
  ...
  def make
    opts = @_entopts.dup
    VatcomplyApiRootEntity.new(@_client, opts)
  end
  ...
  # @return [VatcomplyApiRoot, Hash] the current VatcomplyApiRoot data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of VatcomplyApiRoot fields)
  def match_get
  ...
  #
  # @param reqmatch [VatcomplyApiRootLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.VatcomplyApiRoot.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [VatcomplyApiRoot, Hash] the loaded VatcomplyApiRoot; raises VatValidationError on failure
