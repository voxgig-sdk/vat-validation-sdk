...
## Install
```bash
go get github.com/voxgig-sdk/vat-validation-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/vat-validation-sdk=../path/to/github.com/voxgig-sdk/vat-validation-sdk
```
...
```
github.com/voxgig-sdk/vat-validation-sdk/
...
The root package (`github.com/voxgig-sdk/vat-validation-sdk`) re-exports everything needed
