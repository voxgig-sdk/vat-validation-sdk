...
func NewGeolocateEntity(client *core.VatValidationSDK, entopts map[string]any) *GeolocateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GeolocateEntity) GetName() string { return e.name }
...
func (e *GeolocateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GeolocateEntity) Deleted() bool {
	return e.deleted
}


func (e *GeolocateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGeolocateEntity(e.client, opts)
}

func (e *GeolocateEntity) Data(args ...any) any {
...
func (e *GeolocateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Geolocate; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GeolocateEntity) DataTyped(data ...Geolocate) Geolocate {
	if len(data) > 0 {
		return typedFrom[Geolocate](e.Data(asMap(data[0])))
	}
	return typedFrom[Geolocate](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Geolocate (all fields
// optional at the wire level).
func (e *GeolocateEntity) MatchTyped(match ...Geolocate) Geolocate {
	if len(match) > 0 {
		return typedFrom[Geolocate](e.Match(asMap(match[0])))
	}
	return typedFrom[Geolocate](e.Match())
}
...
func (e *GeolocateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GeolocateEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GeolocateLoadMatch and returns an Geolocate. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GeolocateEntity) LoadTyped(reqmatch GeolocateLoadMatch, ctrl map[string]any) (Geolocate, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Geolocate{}, err
	}
	return typedFrom[Geolocate](res), nil
}



func (e *GeolocateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GeolocateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GeolocateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GeolocateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GeolocateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
