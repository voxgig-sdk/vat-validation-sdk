...
type ValidateVatResponseSchemaEntity struct {
	name    string
...
func NewValidateVatResponseSchemaEntity(client *core.VatValidationSDK, entopts map[string]any) *ValidateVatResponseSchemaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &ValidateVatResponseSchemaEntity{
...
func (e *ValidateVatResponseSchemaEntity) GetName() string { return e.name }
...
func (e *ValidateVatResponseSchemaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ValidateVatResponseSchemaEntity) Deleted() bool {
	return e.deleted
}


func (e *ValidateVatResponseSchemaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewValidateVatResponseSchemaEntity(e.client, opts)
}

func (e *ValidateVatResponseSchemaEntity) Data(args ...any) any {
...
func (e *ValidateVatResponseSchemaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ValidateVatResponseSchemaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ValidateVatResponseSchemaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ValidateVatResponseSchemaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ValidateVatResponseSchemaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ValidateVatResponseSchemaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ValidateVatResponseSchemaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
