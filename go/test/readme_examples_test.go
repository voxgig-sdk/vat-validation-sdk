...
const testSeed = `map[string]any{"entity": map[string]any{"country": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "currency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "geolocate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rate": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "validate_iban_response_schema": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "validate_vat_response_schema": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "vatcomply_api_root": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
