...
func TestValidateIbanResponseSchemaEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set VATVALIDATION_TEST_VALIDATE_IBAN_RESPONSE_SCHEMA_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func validate_iban_response_schemaBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("VATVALIDATION_TEST_VALIDATE_IBAN_RESPONSE_SCHEMA_ENTID")
