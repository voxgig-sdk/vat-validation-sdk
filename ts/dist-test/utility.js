...
function envOverride(m) {
    if ('TRUE' === process.env.VAT_VALIDATION_TEST_LIVE ||
        'TRUE' === process.env.VAT_VALIDATION_TEST_OVERRIDE) {
    ...
    m.VAT_VALIDATION_TEST_EXPLAIN = process.env.VAT_VALIDATION_TEST_EXPLAIN || m.VAT_VALIDATION_TEST_EXPLAIN;
    return m;
}
