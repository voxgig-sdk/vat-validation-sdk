...
(0, node_test_1.describe)('GeolocateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-geolocate', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-geolocate', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VAT_VALIDATION_TEST_GEOLOCATE_ENTID'];
...
//# sourceMappingURL=GeolocateDirect.test.js.map