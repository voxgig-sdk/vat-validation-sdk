...
(0, node_test_1.describe)('ValidateVatResponseSchemaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-validate_vat_response_schema', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-validate_vat_response_schema', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VAT_VALIDATION_TEST_VALIDATE_VAT_RESPONSE_SCHEMA_ENTID'];
...
//# sourceMappingURL=ValidateVatResponseSchemaDirect.test.js.map