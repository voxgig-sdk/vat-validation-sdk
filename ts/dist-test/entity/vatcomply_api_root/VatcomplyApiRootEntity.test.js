...
(0, node_test_1.describe)('VatcomplyApiRootEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let vatcomply_api_root_ref01_data = Object.values(setup.data.existing.vatcomply_api_root)[0];
        // LOAD
        const vatcomply_api_root_ref01_ent = client.VatcomplyApiRoot();
        const vatcomply_api_root_ref01_match_dt0 = {};
        const vatcomply_api_root_ref01_data_dt0 = (await vatcomply_api_root_ref01_ent.load(vatcomply_api_root_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != vatcomply_api_root_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/vatcomply_api_root/VatcomplyApiRootTestData.json');
    ...
    let idmap = transform(['vatcomply_api_root01', 'vatcomply_api_root02', 'vatcomply_api_root03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=VatcomplyApiRootEntity.test.js.map