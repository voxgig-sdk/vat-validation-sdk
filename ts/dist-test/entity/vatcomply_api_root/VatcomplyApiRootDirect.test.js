...
(0, node_test_1.describe)('VatcomplyApiRootDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-vatcomply_api_root', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-vatcomply_api_root', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VAT_VALIDATION_TEST_VATCOMPLY_API_ROOT_ENTID'];
...
//# sourceMappingURL=VatcomplyApiRootDirect.test.js.map