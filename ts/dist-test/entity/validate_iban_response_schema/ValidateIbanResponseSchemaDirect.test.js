...
(0, node_test_1.describe)('ValidateIbanResponseSchemaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.VatValidationSDK({
    ...
    (0, node_test_1.test)('direct-load-validate_iban_response_schema', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-validate_iban_response_schema', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.VAT_VALIDATION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.VatValidationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['VAT_VALIDATION_TEST_VALIDATE_IBAN_RESPONSE_SCHEMA_ENTID'];
    ...
    const client = new __1.VatValidationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ValidateIbanResponseSchemaDirect.test.js.map