...
(0, node_test_1.describe)('ValidateIbanResponseSchemaEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'validate_iban_response_schema.' + op, live))
                return;
        }
        ...
        let validate_iban_response_schema_ref01_data = Object.values(setup.data.existing.validate_iban_response_schema)[0];
        // LOAD
        const validate_iban_response_schema_ref01_ent = client.ValidateIbanResponseSchema();
        const validate_iban_response_schema_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(null != validate_iban_response_schema_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/validate_iban_response_schema/ValidateIbanResponseSchemaTestData.json');
    ...
    let idmap = transform(['validate_iban_response_schema01', 'validate_iban_response_schema02', 'validate_iban_response_schema03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['VAT_VALIDATION_TEST_VALIDATE_IBAN_RESPONSE_SCHEMA_ENTID'];
...
//# sourceMappingURL=ValidateIbanResponseSchemaEntity.test.js.map