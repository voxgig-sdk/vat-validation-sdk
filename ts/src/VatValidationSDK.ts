...
class VatValidationSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('VatValidationSDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Geolocate(entopts?: Record<string, any>) {
    const self = this
    return new GeolocateEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ValidateIbanResponseSchema(entopts?: Record<string, any>) {
    const self = this
    return new ValidateIbanResponseSchemaEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ValidateVatResponseSchema(entopts?: Record<string, any>) {
    const self = this
    return new ValidateVatResponseSchemaEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  VatcomplyApiRoot(entopts?: Record<string, any>) {
    const self = this
    return new VatcomplyApiRootEntity(self, entopts)
  }
