...
class ValidateIbanResponseSchemaEntity extends VatValidationEntityBase<ValidateIbanResponseSchema> {
  ...
  make(this: ValidateIbanResponseSchemaEntity) {
    return new ValidateIbanResponseSchemaEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: ValidateIbanResponseSchemaLoadMatch, ctrl?: Control): Promise<ValidateIbanResponseSchemaEntity> {
