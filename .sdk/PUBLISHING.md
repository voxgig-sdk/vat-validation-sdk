...
|---|---|---|
| `ts/` | @voxgig-sdk/vat-validation-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/vat-validation-sdk \
      --repository voxgig-sdk/vat-validation-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/vat-validation-sdk` shows it, and
`npm trust revoke @voxgig-sdk/vat-validation-sdk --id=<id>` removes it.
