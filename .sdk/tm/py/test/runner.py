...
class VatValidationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = VatValidationTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = VatValidationTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = VatValidationTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
