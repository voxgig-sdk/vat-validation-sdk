...
class VatValidationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = VatValidationTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = VatValidationTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = VatValidationTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
