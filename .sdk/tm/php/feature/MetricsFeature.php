...
// VatValidation SDK metrics feature
...
class VatValidationMetricsFeature extends VatValidationBaseFeature
{
    ...
    private function _record(VatValidationContext $ctx, bool $ok): void
    {
