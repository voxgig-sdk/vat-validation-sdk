...
// VatValidation SDK ratelimit feature
...
class VatValidationRatelimitFeature extends VatValidationBaseFeature
{
    ...
    private function _acquire(VatValidationContext $ctx): void
    {
    ...
    private function _track(VatValidationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
