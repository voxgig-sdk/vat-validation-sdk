...
// VatValidation SDK streaming feature
...
class VatValidationStreamingFeature extends VatValidationBaseFeature
{
    ...
    private function _iterate(VatValidationResult $result): \Generator
    {
    ...
    private function _streamable(VatValidationContext $ctx): bool
    {
