...
// VatValidation SDK idempotency feature
...
class VatValidationIdempotencyFeature extends VatValidationBaseFeature
{
    ...
    private function _mutating(VatValidationContext $ctx): bool
    {
