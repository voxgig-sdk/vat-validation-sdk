...
// VatValidation SDK cache feature
...
class VatValidationCacheFeature extends VatValidationBaseFeature
{
    ...
    private function _through(VatValidationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
