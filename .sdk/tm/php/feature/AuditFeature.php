...
// VatValidation SDK audit feature
...
class VatValidationAuditFeature extends VatValidationBaseFeature
{
    ...
    private function _emit(VatValidationContext $ctx, string $outcome): void
    {
