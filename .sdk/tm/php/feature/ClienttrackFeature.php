...
// VatValidation SDK clienttrack feature
...
class VatValidationClienttrackFeature extends VatValidationBaseFeature
{
    ...
    public function PostConstruct(VatValidationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'VatValidation-SDK';
