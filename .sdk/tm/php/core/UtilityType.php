...
// VatValidation SDK utility type

class VatValidationUtility
{
    ...
    public static function copy(VatValidationUtility $src): VatValidationUtility
    {
        $u = new VatValidationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
