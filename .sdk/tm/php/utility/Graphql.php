...
// VatValidation SDK utility: graphql
//
...
class VatValidationGraphql
{
    ...
    // equivalent.
    public static function body(VatValidationContext $ctx): mixed
    {
    ...
    public static function errors(VatValidationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
