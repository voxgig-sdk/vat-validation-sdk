...
// VatValidation SDK utility: make_options

class VatValidationMakeOptions
{
    ...
    public static function call(VatValidationContext $ctx): array
    {
        ...
        //
        // `VatValidationSchema::optspec()` is built from the model:
        ...
        $optspec = VatValidationSchema::optspec();
