# VatValidation Lua SDK

The Lua SDK for the VatValidation API. Provides an entity-oriented interface using Lua conventions.
...
local result, err = client:VatValidation(nil):load(
  { id = "test01" }, nil
)
...
```
lua/
├── vat-validation_sdk.lua    -- Main SDK module
...
The main module (`vat-validation_sdk`) exports the SDK constructor
