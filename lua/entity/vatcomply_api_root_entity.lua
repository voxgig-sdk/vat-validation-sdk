...
local VatcomplyApiRootEntity = {}
VatcomplyApiRootEntity.__index = VatcomplyApiRootEntity


function VatcomplyApiRootEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, VatcomplyApiRootEntity)
  self._name = "vatcomply_api_root"
  self._client = client
...
function VatcomplyApiRootEntity:get_name()
  return self._name
end


function VatcomplyApiRootEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return VatcomplyApiRootEntity.new(self._client, opts)
end
...
function VatcomplyApiRootEntity:mark_deleted()
  self._deleted = true
end


function VatcomplyApiRootEntity:deleted()
  return true == self._deleted
end


function VatcomplyApiRootEntity:data_set(args)
  if args ~= nil then
...
function VatcomplyApiRootEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function VatcomplyApiRootEntity:match_set(args)
  if args ~= nil then
...
function VatcomplyApiRootEntity:match_get()
...
function VatcomplyApiRootEntity:stream(action, args, callopts)
...
---@param reqmatch VatcomplyApiRootLoadMatch
---@param ctrl? table
---@return VatcomplyApiRoot
---@return string? err
function VatcomplyApiRootEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function VatcomplyApiRootEntity:_run_op(ctx, post_done)
  local utility = self._utility
