...
local ValidateIbanResponseSchemaEntity = {}
ValidateIbanResponseSchemaEntity.__index = ValidateIbanResponseSchemaEntity


function ValidateIbanResponseSchemaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ValidateIbanResponseSchemaEntity)
  self._name = "validate_iban_response_schema"
  self._client = client
...
function ValidateIbanResponseSchemaEntity:get_name()
  return self._name
end


function ValidateIbanResponseSchemaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ValidateIbanResponseSchemaEntity.new(self._client, opts)
end
...
function ValidateIbanResponseSchemaEntity:mark_deleted()
  self._deleted = true
end


function ValidateIbanResponseSchemaEntity:deleted()
  return true == self._deleted
end


function ValidateIbanResponseSchemaEntity:data_set(args)
  if args ~= nil then
...
function ValidateIbanResponseSchemaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ValidateIbanResponseSchemaEntity:match_set(args)
  if args ~= nil then
...
function ValidateIbanResponseSchemaEntity:match_get()
...
function ValidateIbanResponseSchemaEntity:stream(action, args, callopts)
...
function ValidateIbanResponseSchemaEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ValidateIbanResponseSchemaEntity
