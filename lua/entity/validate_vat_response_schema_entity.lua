...
local ValidateVatResponseSchemaEntity = {}
ValidateVatResponseSchemaEntity.__index = ValidateVatResponseSchemaEntity


function ValidateVatResponseSchemaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ValidateVatResponseSchemaEntity)
  self._name = "validate_vat_response_schema"
  self._client = client
...
function ValidateVatResponseSchemaEntity:get_name()
  return self._name
end


function ValidateVatResponseSchemaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ValidateVatResponseSchemaEntity.new(self._client, opts)
end
...
function ValidateVatResponseSchemaEntity:mark_deleted()
  self._deleted = true
end


function ValidateVatResponseSchemaEntity:deleted()
  return true == self._deleted
end


function ValidateVatResponseSchemaEntity:data_set(args)
  if args ~= nil then
...
function ValidateVatResponseSchemaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ValidateVatResponseSchemaEntity:match_set(args)
  if args ~= nil then
...
function ValidateVatResponseSchemaEntity:match_get()
...
function ValidateVatResponseSchemaEntity:stream(action, args, callopts)
...
function ValidateVatResponseSchemaEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ValidateVatResponseSchemaEntity
