...
describe("VatcomplyApiRootDirect", function()
  it("should direct-load-vatcomply_api_root", function()
    local setup = vatcomply_api_root_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-vatcomply_api_root", setup.live and "live" or "unit")
...
function vatcomply_api_root_direct_setup(mockres)
