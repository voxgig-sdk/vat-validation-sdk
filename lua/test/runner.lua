...
function runner.env_override(m)
  local live = runner.getenv("VAT_VALIDATION_TEST_LIVE")
  local override = runner.getenv("VAT_VALIDATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("VAT_VALIDATION_TEST_EXPLAIN")
