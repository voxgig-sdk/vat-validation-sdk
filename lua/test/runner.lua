...
function runner.env_override(m)
  local live = runner.getenv("VATVALIDATION_TEST_LIVE")
  local override = runner.getenv("VATVALIDATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("VATVALIDATION_TEST_EXPLAIN")
