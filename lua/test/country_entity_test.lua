...
describe("CountryEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set VAT_VALIDATION_TEST_COUNTRY_ENTID JSON to run live")
      return
    end
...
function country_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("VAT_VALIDATION_TEST_COUNTRY_ENTID")
