-- ValidateVatResponseSchema direct test
...
describe("ValidateVatResponseSchemaDirect", function()
  it("should direct-load-validate_vat_response_schema", function()
    local setup = validate_vat_response_schema_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-validate_vat_response_schema", setup.live and "live" or "unit")
...
function validate_vat_response_schema_direct_setup(mockres)
