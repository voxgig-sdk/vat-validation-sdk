...
describe("GeolocateDirect", function()
  it("should direct-load-geolocate", function()
    local setup = geolocate_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-geolocate", setup.live and "live" or "unit")
...
function geolocate_direct_setup(mockres)
