...
local VatValidationSDK = {}
VatValidationSDK.__index = VatValidationSDK
...
VatValidationSDK._make_feature = _make_feature


function VatValidationSDK.new(options)
  local self = setmetatable({}, VatValidationSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function VatValidationSDK:options_map()
...
function VatValidationSDK:get_utility()
  return Utility.copy(self._utility)
end


function VatValidationSDK:get_root_ctx()
  return self._rootctx
end


function VatValidationSDK:prepare(fetchargs)
...
function VatValidationSDK:direct(fetchargs)
...
-- by passing it.
function VatValidationSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function VatValidationSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "VatValidationSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function VatValidationSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = VatValidationSDK.new(sdkopts)
  sdk.mode = "test"
